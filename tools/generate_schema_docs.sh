...
echo "Generating schema docs for iptc-sport-facets.ttl"
tools/generate_schema_docs.py --include-inherited --include-inverse --jekyll --jekyllnavname "Sport Facets" --jekyllnavparent "Ontology reference" --jekyllnavlink "/ontologies/sport-facets" --jekyllnavorder 3 ontologies/iptc-sport-facets.ttl docs/ontologies/sport-facets.html

echo "Generating schema docs for american-football-statistics.ttl"
tools/generate_schema_docs.py --include-inherited --include-inverse --jekyll --jekyllnavname "American Football ontology" --jekyllnavparent "Ontology reference" --jekyllnavlink "/ontologies/american-football" --jekyllnavorder 4 ontologies/iptc-sport-american-football-statistics.ttl docs/ontologies/american-football-statistics.html

echo "Generating schema docs for baseballstatistics.ttl"
tools/generate_schema_docs.py --include-inherited --include-inverse --jekyll --jekyllnavname "Baseball ontology" --jekyllnavparent "Ontology reference" --jekyllnavlink "/ontologies/baseball" --jekyllnavorder 5 ontologies/iptc-sport-baseball-statistics.ttl docs/ontologies/baseball-statistics.html

echo "Generating schema docs for basketball-statistics.ttl"
tools/generate_schema_docs.py --include-inherited --include-inverse --jekyll --jekyllnavname "Basketball ontology" --jekyllnavparent "Ontology reference" --jekyllnavlink "/ontologies/basketball" --jekyllnavorder 6 ontologies/iptc-sport-basketball-statistics.ttl docs/ontologies/basketball-statistics.html

echo "Generating schema docs for esports-statistics.ttl"
tools/generate_schema_docs.py --include-inherited --include-inverse --jekyll --jekyllnavname "esports ontology" --jekyllnavparent "Ontology reference" --jekyllnavlink "/ontologies/esports" --jekyllnavorder 7 ontologies/iptc-sport-esports-statistics.ttl docs/ontologies/esports-statistics.html

echo "Generating schema docs for golf.ttl"
tools/generate_schema_docs.py --include-inherited --include-inverse --jekyll --jekyllnavname "Golf ontology" --jekyllnavparent "Ontology reference" --jekyllnavlink "/ontologies/golf" --jekyllnavorder 8 ontologies/iptc-sport-golf.ttl docs/ontologies/golf.html
